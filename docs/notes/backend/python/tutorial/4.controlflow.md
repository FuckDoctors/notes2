...
<Replit link="https://replit.com/@zhaobin/python-tutorial#4.2/for.py" />
...
<Replit link="https://replit.com/@zhaobin/python-tutorial#4.4/else.py" />
...
<Replit link="https://replit.com/@zhaobin/python-tutorial#4.6/match-http-error.py" />
